...
title: Text(AppLocalizations.of(context).translate("alert_title")),
content:  Text(AppLocalizations.of(context).translate("alert_text") ),
        actions: <Widget>[
          FlatButton(
            child: Text(AppLocalizations.of(context).translate("yes_button")),
            onPressed: () {
              exit(0);
...
FlatButton(
            child: Text(AppLocalizations.of(context).translate("no_button")),
            onPressed: () {
        ...
        child: BlocProvider(
            ...
            drawer: Drawer(
              child: ListView(
                children: <Widget>[
                  ListTile(
                    title: Text(AppLocalizations.of(context).translate("tab1Title") ),
                    onTap: () {
                  ...
                  ListTile(
                    title: Text(AppLocalizations.of(context).translate("tab2Title")),
                    onTap: () {
                    ...
                    itemBuilder: (BuildContext context) {
                      return types.map((loc) {
                        return PopupMenuItem(
                          value: loc,
                          child: ListTile(
                            title: Text(AppLocalizations.of(context).translate("tab${types.indexOf(loc)+1}Title") ),
                          ),
                        );
                      }).toList();
                    },
...
icon: Icon(Icons.search),
        ...
        title:new Text(AppLocalizations.of(context).translate("appTitle")),
